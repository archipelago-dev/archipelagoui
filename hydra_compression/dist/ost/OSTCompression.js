...
exports.OSTHelper = exports.OSTCompression = void 0;
...
class OSTCompression {
    ...
    async decode(compressedData) {
        ...
        // Decompress each bin
        const decompressedBins = new Map();
    ...
    async compressBin(bin) {
        ...
        switch (this.config.compressionMethod) {
            ...
            case 'brotli':
                return (0, brotli_wasm_1.compress)(data);
            case 'zstd':
                return (0, zstd_wasm_1.compress)(data);
            case 'raw':
            default:
                return data;
        }
    ...
    async decompressBin(compressedData) {
        switch (this.config.compressionMethod) {
            ...
            case 'brotli':
                return new TextDecoder().decode(await (0, brotli_wasm_1.decompress)(compressedData));
            case 'zstd':
                return new TextDecoder().decode(await (0, zstd_wasm_1.decompress)(compressedData));
            case 'raw':
            default:
...
exports.OSTCompression = OSTCompression;
/**
        ...
        switch (type) {
            ...
            case 'elias-delta':
                return {
                    encode: (n) => {
                        ...
                        const gammaCodec = exports.OSTHelper.createUniversalCodec('elias-gamma');
            ...
            case 'fibonacci':
                return {
                    encode: (n) => {
                        if (n <= 0)
                            throw new Error("Fibonacci code can only encode positive integers");
            ...
            case 'unary':
                return {
                    encode: (n) => {
                        if (n <= 0)
                            throw new Error("Unary code can only encode positive integers");
                        return '1'.repeat(n) + '0';
                    },
                    decode: (bits) => {
...
*/ 
//# sourceMappingURL=OSTCompression.js.map